...
enum irecv_type {
	IRECV_K_DFU_TYPE	= 1,	//default RECOVERY or DFU
	IRECV_K_IBOOT_TYPE	= 2,	//iboot
	IRECV_K_ADFU_TYPE	= 3,	//adfu  (iPhone 14 Pro DFU Mode(System Device --> Apple RSM))
};
...
enum irecv_mode {
	...
	IRECV_K_ADFU_MODE		  = 0x0001,	//iPhone 14 Pro DFU Mode(System Device --> Apple RSM)
};
